...
\begin{itemize}
    \item \textbf{SharedPreferences}: stockage primitif sous forme de mapping clé / valeur
    \item \textbf{Fichiers}: contenus sur la mémoire interne ou externe (micro SD)
