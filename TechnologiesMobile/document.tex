...
\frametitle{Les Views}
  \begin{itemize}
    \item Une vue = un élement à l'écran
...
\end{frame}
\begin{frame}[fragile]
\frametitle{Accéder aux éléments de l'UI en java}
...
public Class MyActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		monTexte = (TextView) findViewById(R.id.matextview);
	}
}
\end{lstlisting}
\end{frame}
...
Système de listeners, comme sur swing
\end{frame}
