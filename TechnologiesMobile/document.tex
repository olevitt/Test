...
{ 
    "cours": [
    {"titre": "Technologies mobile","salle": "010"},
    {"titre": "Stat 3","salle": "011"}
    ]
}
\end{lstlisting}
XML :
\begin{lstlisting}
<EmploiDuTemps>
<Cours titre="Technologies mobile" salle="010" />
<Cours titre="Stat 3" salle="011" />
</EmploiDuTemps>
\end{lstlisting}
\end{frame}
\begin{frame}[fragile]
...
\end{lstlisting}
\includegraphics[width=150pt]{anr.png}
\begin{itemize}
