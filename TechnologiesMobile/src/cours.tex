...
\begin{itemize}
  ...
  \item{13 mail : Soutenance du projet}
\end{itemize}
}
...
\begin{itemize}
  ...
  \item{Groupe de 2}
  \item{Choix de la technologie ``libre''}
  \item{Sujet ``libre''}
...
\begin{itemize}
  ...
  \item Capteurs (Luminosité, proximité, podomètre)
...
\begin{itemize}
  ...
  \item Premiers téléphones présentés le 22 janvier (geeksphone)
...
\end{itemize}
\includegraphics[width=300pt]{img/avd.png}
\includegraphics[width=42pt]{img/emu.png}
}
\frame{
...
\end{itemize}
\includegraphics[width=170pt]{img/x86.png}
}
