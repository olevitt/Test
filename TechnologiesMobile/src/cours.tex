...
\date{Source et pdf de ce cours et des TP
:\\\url{https://bitbucket.org/olevitt/technologies-mobiles/src}}
\AtBeginSubsection[]
{
  \begin{frame}
  \frametitle{Sommaire}
...
\titlepage
\begin{center}
\includegraphics[width=60pt]{img/google-android.jpg}
...
\frametitle{Planning}
\begin{itemize}
  \item{27 mars : 3h de cours, 1h30 de TP}
  \item{3 avril : 3h de cours, 1h30 de TP}
  \item{10 avril : 4h30 de TP}
  \item{Validation des sujets de projet avant le 17 avril}
  \item{17 avril : 4h30 de TP dédiées au projet}
  \item{25 avril : 3h de TP dédiées au projet}
  \item{13 mai : Soutenance du projet}
\end{itemize}
}
...
\begin{itemize}
  ...
  \item{Groupe de 2}
  \item{Sujet ``libre''}
  \item{7h30 de TP dédiées au projet + \textbf{travail personnel}}
...
Une application publiée sur le google playstore cible plus de 5300 appareils
différents !\\
\begin{itemize}
...
\begin{itemize}
  ...
  \item Plus de 5300 appareils officiellement supportés, plus de 50
  constructeurs
...
\begin{itemize}
  ...
  \item Windows Store : validation + 19\$ / an
\end{itemize}
}
\frame{
...
\begin{tabular}{|l|c|c|c|r|}
  ...
  2.1 & Eclair & 7 & 0\% & 100\% \\
  2.2 & Froyo & 8 & 1.2\% & 100\% \\
  2.3 & Gingerbread & 9/10 & 19\% & 98.8\% \\
  3.X & Honeycomb & 12/13 & 0.1\% & 79.8\% \\
  4.0 & Ice cream sandwich & 15 & 15.2\% & 79.7\% \\
  4.1 & Jelly bean & 16 & 35.3\% & 64.5\% \\
  4.2 & Jelly bean & 17 & 17.1\% & 29.2\% \\
  4.3 & Jelly bean & 18 & 9.6\% & 12.1\% \\
  4.4 & Kitkat & 19 & 2.5\% & 2.5\% \\
  \hline
\end{tabular}
\caption{\label{s}Répartition des versions pour les accès au google play sur la
dernière semaine de février 2014}
\end{table}
}
\frame{
...
\begin{itemize}
  \item Basé sur IntelliJ IDEA (et non sur eclipse)
  \item IDE retravaillé pour android
  \item Version ``early access preview'' (beta)
\end{itemize}
...
\begin{itemize}
  ...
  \item \url{http://www.genymotion.com}
  \item \url{http://www.android-x86.org/}
  \item Quelques appareils android sous x86 ``intel inside''
\end{itemize}
\includegraphics[width=150pt]{img/x86.png}
}
...
\begin{itemize}
 ...
 est prévenu
 \item Pour simplifier, sur android on a en général qu'un listener par événement
...
\begin{itemize}
  ...
  \item Pas de point d'entrée unique
  \item Tous les composants doivent être définis dans le manifest
  \item Activity, composant +/- = un écran
...
\begin{itemize}
  ...
  \item Layout = hierarchie de ViewGroup et de View
...
\begin{itemize}
  \item Implémenter OnxxxListener (ex : OnClickListener)
  \item S'enregistrer comme listener auprès de la View
  (ex : bouton.setOnClickListener(\ldots))
  \item Chaque évenement correspond à un appel de la méthode implémentée
  \item Feinte 1 : déclarer le listener dans le layout XML (View onClick)
  \item Feinte 2 : enregistrer des listeners anonymes (crées ad-hoc)
\end{itemize}
\end{frame}
\begin{frame}[fragile]
...
\begin{itemize}
  ...
  \item Attribut layout\_weight définis dans les fils
  \item Les views occupent l'espace restant au prorata de leur importance
  \item Si layout\_weight est pas défini, il vaut 0
\end{itemize}
\end{frame}
\begin{frame}[fragile]
...
\begin{itemize}
  ...
  les fichiers layout
  \item Manipuler des views = leur donner et un identifiant et faire
  findViewById
\end{itemize}
\end{frame}
\begin{frame}[fragile]
...
\begin{itemize}
  ...
  \item Un webservice ne renvoit pas de HTML (données + présentation) mais des
...
\begin{itemize}
  \item Problématique : Les tâches à executer peuvent parfois être (très)
  longues
...
Pensez à envoyer les idées de projet et les compositions de groupe avant la
semaine prochaine (17 avril)\\
Email : gon1@free.fr
\end{frame}
\end{document}
