...
\date{Source et pdf de ce cours et des TP :\\\url{http://goo.gl/rA09Sp}}
\AtBeginSubsection[]
{
  \begin{frame}
  \frametitle{Sommaire}
...
\begin{itemize}
  ...
  \item Version standalone d'eclipse : ADT bundle
\end{itemize}
...
\begin{itemize}
  ...
  \item Résultat : émulateur (très) lent
