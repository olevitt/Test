...
\frametitle{Planning}
\begin{itemize}
  \item{19 avril : 3h de cours}
  \item{26 avril : 3h de TP, 3h de cours}
  \item{3 mai : 6h de TP}
  \item{Validation des sujets de projet avant le 10 mai}
  \item{10 mai : 3h de TP, 3h de TP dédiées au projet}
  \item{24 mai : Soutenance du projet}
\end{itemize}
}
...
\begin{tabular}{|l|c|c|c|r|}
  ...
  \hline
  2.2 & Froyo & 8 & 0.1\% & 100\% \\
  2.3 & Gingerbread & 9/10 & 2.6\% & 99.9\% \\
  4.0 & Ice cream sandwich & 15 & 2.2\% & 97.3\% \\
  4.1 & Jelly bean & 16 & 7.8\% & 95.1\% \\
  4.2 & Jelly bean & 17 & 10.5\% & 87.3\% \\
  4.3 & Jelly bean & 18 & 3.0\% & 76.8\% \\
  4.4 & Kitkat & 19 & 33.4\% & 73.8\% \\
  5.0 & Lollipop & 21 & 16.4\% & 40.4\% \\
  5.1 & Lollipop & 22 & 19.4\% & 24\% \\
  6.0 & Marshmallow & 23 & 4.6\% & 4.6\% \\
  \hline
\end{tabular}
\caption{\label{s}Répartition des versions pour les accès au google play sur la
première semaine d'avril 2016}
\end{table}
}
