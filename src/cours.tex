...
\date{Source et pdf de ce cours et des TP :\\\url{https://goo.gl/eIPv5B}}
\AtBeginSubsection[]
{
  \begin{frame}
  \frametitle{Sommaire}
...
\includegraphics[width=100pt,height=30pt]{img/windows10.png}  
\includegraphics[width=60pt]{img/bb10.jpg}
\includegraphics[width=80pt]{img/firefox.png}
\end{center}
} 
...
\frametitle{Planning}
\begin{itemize}
  \item{13 avril : 3h de cours}
  \item{25 avril : 3h de TP, 3h de cours}
  \item{2 mai : 6h de TP}
  \item{Validation des sujets de projet avant le 9 mai}
  \item{9 mai : 3h de TP, 3h de TP dédiées au projet}
  \item{31 mai : Soutenance du projet}
\end{itemize}
}
...
\begin{itemize}
  ...
  \item{Répondeur SMS}
  \item{Quiz}
  \item{Transports de rennes}
  \item Open data (ex : \url{http://data.gouv.fr})
\end{itemize}
}
...
\begin{itemize}
  ...
  jeu \ldots)
  \item Développement natif d'application, pas de dev système
...
\begin{itemize}
  ...
  \item Réseaux locaux (Bluetooth, WiFi direct, tethering)
  \item Capteurs (Luminosité, proximité, gyroscope, NFC)
...
\begin{itemize}
  ...
  \item Phablets : 5 à 6 pouces (Galaxy note, Oneplus two, iPhone 6)
...
\\
\begin{itemize}
  \item Alternative cross-platform ?
\end{itemize}
}
...
\begin{itemize}
  ...
  \item Programmation en objective-C (+ swift), sur mac OS X uniquement
...
\begin{itemize}
  ...
  \item Version 1.0 en septembre 2008, commerciale 1.5 en avril 2009
  \item Plus de 6000 appareils officiellement supportés, plus de 50
  constructeurs
  \item Programmation en Java (+kotlin), sur Windows / OS X / Linux
...
\includegraphics[width=60pt]{img/windows10.png}
\begin{itemize}
  \item Soutenu par Microsoft
  \item Première version en février 2015
  \item Téléphones Lumia (ex Nokia)
...
\includegraphics[width=60pt]{img/firefox.png}
\begin{itemize}
...
\begin{itemize}
  ...
  \item Constructeur BQ + installable sur Android
  \item HTML5, C/C++ + QML
  \item Open-source
  \item Convergence PC
  \item Ubuntu store : validation automatique + gratuit
\end{itemize}
\textbf{RIP}
}
...
Téléchargement : \\\url{https://developer.android.com/studio/index.html}
\begin{itemize}
  \item SDK
  \item IDE
\end{itemize}
...
\frametitle{ADB}
\begin{itemize}
  \item Android Debugging Bridge
  \item Outil du SDK
  \item Communication ordinateur $<$=$>$ appareil / émulateur
  \item Installation d'application, lancement, log \ldots
  \item Intégré dans l'IDE ou ligne de commande
\end{itemize}
}
\frame{
\frametitle{IDE | Plugin android pour eclipse : ADT}
\begin{itemize}
...
\begin{itemize}
  ...
  \item Lent
  \item Se comporte comme un appareil Android classique (ADB)
...
\begin{tabular}{|l|c|c|c|r|}
  ...
  \hline
  2.3 & Gingerbread & 10 & 0.9\% & 100\% \\
  4.0 & Ice cream sandwich & 15 & 0.9\% & 99.1\% \\
  4.1 & Jelly bean & 16 & 3.5\% & 98.2\% \\
  4.2 & Jelly bean & 17 & 5.1\% & 94.7\% \\
  4.3 & Jelly bean & 18 & 1.5\% & 89.6\% \\
  4.4 & Kitkat & 19 & 20.0\% & 88.1\% \\
  5.0 & Lollipop & 21 & 9.0\% & 68.1\% \\
  5.1 & Lollipop & 22 & 23.0\% & 59.1\% \\
  6.0 & Marshmallow & 23 & 31.2\% & 36.1\% \\
  7.0 & Nougat & 24 & 4.5\% & 4.9\% \\
  7.1 & Nougat & 25 & 0.4\% & 0.4\% \\
  \hline
\end{tabular}
\caption{\label{s}Répartition des versions pour les accès au google play sur la
première semaine d'avril 2017}
\end{table}
}
...
\frametitle{Gradle}
\begin{itemize}
  \item Gestion des dépendances et du build
  \item ``Successeur'' de maven
  \item Optionnel mais fortement recommandé
  \item Conf dans build.gradle
\end{itemize}
}
\frame{
\frametitle{Organisation d'un projet Android gradleisé}
\includegraphics[width=120pt]{img/structure-studio.png}
}

\frame{
\frametitle{Détail de l'organisation}
\begin{itemize}
  \item .gradle / gradle : dossiers interne gradle
  \item .idea : dossier interne android studio
  \item mobile : module téléphone / tablette
  \item wear : module android wear (montre)
  \item build : résultats des compilations dont APK
  \item libs : dépendances manuelles
  \item src : code source
  \item main / java : code source Java
  \item main / res : Ressources (strings, drawables \ldots)
  \item AndroidManifest.xml : métadonnées sur l'application, composants,
  permissions \ldots
  \item tests / androidTest : tests unitaires / tests fonctionnels
  \item build.gradle : configuration gradle
  \item proguard-rules.pro : configuration proguard
 \end{itemize}
}
\frame{
...
\end{lstlisting}
\begin{itemize}
  \item Depuis Android 6.0 (API 23), permissions au runtime
 \end{itemize}
\end{frame} 
...
\begin{itemize}
  ...
  \item Création et signature de l'APK simplifié par l'IDE
 \end{itemize}
}
\frame{
...
\begin{itemize}
  \item Android Studio demande au SDK de builder l'APK
  \item AS signe l'APK avec la clé debug 
  \item AS demande à ADB (SDK) d'installer l'application
...
\includegraphics[width=320pt]{img/ddms.png}
\begin{itemize}
  \item Le debugger Java fonctionne aussi sur Android
  \item Intégré directement à Android Studio
 \end{itemize}
}
...
\begin{itemize}
  ...
  \item On appelle logcat par adb : adb logcat ou on utilise la vue LogCat
  d'Android Studio
...
``Je veux envoyer un mail à annee2@ensai.fr avec le titre URGENT : Android''
\begin{lstlisting}
public MyActivity extends Activity {
    ...
    public void envoyerMail() {
        ...
        i.putExtra(Intent.EXTRA_SUBJECT,"URGENT : Android"); 
...
\begin{itemize}
	...
	fonction des intent-filters de chaque composant
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Stockage distant}: Webservice / cloud
\end{itemize}
...
\end{frame}
\begin{frame}[fragile]
\frametitle{Realm, un exemple d'ORM}
\begin{lstlisting}
...
\end{frame}
\begin{frame}[fragile]
\frametitle{Exemples de ViewGroups : ConstraintLayout}
\begin{itemize}
  \item Version 1.0 le 22 février 2017
  \item Support library (API 9+)
  \item Android studio layout editor
\end{itemize}
\begin{lstlisting}
...
\begin{itemize}
  ...
  \item Api : java.net.HTTPUrlConnection
...
\begin{itemize}
  ...
  \item Le police du fun : StrictMode
\end{itemize}
\end{frame}
\begin{frame}[fragile] 
